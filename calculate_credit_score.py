...
def update_customer_credit_score(p_customer_id):
    ...
    total_loan_amount, total_repayment, outstanding_loan_balance = result.fetchall()[0]
    ...
    """), {"p_customer_id": p_customer_id})
    credit_card_balance = result.fetchall()[0][0]
    ...
    """), {"p_customer_id": p_customer_id})
    late_pay_count = result.fetchall()[0][0]
    ...
    v_credit_score = min(850, max(300, v_credit_score))
